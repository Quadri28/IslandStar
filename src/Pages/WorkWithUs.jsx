...
<div className="container row mx-auto">
        ...
        <p className="text-white">
          We are always seeking professional, committed and motivated coaches to
          deliver our sessions in line with <br /> the Island Star FC way.{" "}
        </p>
      ...
      <div className="text-center">
        <button className="btn btn-md" onClick={()=>openModal()}
        style={{backgroundColor:'#fff', fontSize:'16px', fontWeight:'600'}}>Join Us</button>
      </div>
      </div>
      <Modal
          isOpen={modalIsOpen}
          ...
          ariaHideApp={false}
        >
            <h3 style={{fontSize:'20px', textAlign:'center', fontWeight:'600'}}>
                Your Information
            </h3>
            <Formik 
            ...
            <div className="col-md-5 row g-1">
                ...
                <input name='cv' type="file" style={{border:'none'}}/>
            </div>
            </div>
            <div className="text-center mt-3">
            <button className="btn btn-md text-white" style={{backgroundColor:'#f0990c'}}>Submit</button>
            </div>
            </Form>
            </Formik>
        </Modal>
